...
const initialValues={
  ...
  surnameID:clientData.Surname,
  maritalStatus:clientData.MaritalStatus,
  employmentStatusID:clientData.EmploymentStatus,
  HealthID:clientData.Health,
  preferedNameID:clientData.PreferredName,
  plannedRetirementAgeID:clientData.PlannedRetirementAge,
  ClientDoBID:clientData.DOB,
  employeeAgeID:clientData.Age,
  clientPostalAddressCheckBoxID:false,
  expandFamilyradio:clientData.ExpandFamily,
  healthIssuesradio:clientData.HealthIssues,
  homeAddressID:clientData.HomeAddress,
  homePhoneID:clientData.HomePhone,
  PostcodeID:clientData.Postcode,
  workPhoneID:clientData.WorkPhone,
  emailID:clientData.Email,
  mobileID:clientData.Mobile,

  postalAddressID:clientData.PostalAddress,
  postalPostcodeIDSame:clientData.PostalPostCode,
  DescriptionID:clientData.Description,
 
  // partner
  titleID2:PartnerData.Title,
  givenNameID2:PartnerData.GivenName,
  surnameID2:PartnerData.Surname,
  preferedNameID2:PartnerData.PreferredName,
  maritalStatus2:PartnerData.MaritalStatus,
  employmentStatusID2:PartnerData.EmploymentStatus,
  HealthID2:PartnerData.Health,
  Smoker:PartnerData.Smoker,
  // Gender:'',
  plannedRetirementAgeID2:PartnerData.PlannedRetirementAge,
  ClientDoBID2:PartnerData.DOB,
   employeeAgeID2:PartnerData.Age,
  
  workPhoneID2:PartnerData.WorkPhone,
  mobileID2:PartnerData.Mobile,
  emailID2:PartnerData.Email,
