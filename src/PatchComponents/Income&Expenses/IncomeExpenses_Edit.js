...
useEffect(() => {
  ...
  axios
    .get(`http://localhost:7000/Client-ExpenseIncome`)
    .then((res) => {
    ...
    // partner
    axios
    .get(`http://localhost:7000/Partner-ExpenseIncome`)
    .then((res) => {
...
let currentlySalaryPackageHandler2=(elem)=>{
  ...
  const initialValues={
    ...
    //Client employment details
     ...
     clientUnusedAnnualleaveentitlementsNumber:clientData.Client_AnnualLeaves_Number,
     clientUnusedAnnualleaveentitlementsType:clientData.Client_AnnualLeaves_Type,
     clientUnusedlongserviceleaveNumber:clientData.Client_LongServiceLeaves_Number,
    ...
    // partner employeement Detaails
       ...
       clientUnusedAnnualleaveentitlementsNumber2:PartnerData.Partner_AnnualLeaves_Number,
       clientUnusedAnnualleaveentitlementsType2:PartnerData.Partner_AnnualLeaves_Type,
       clientUnusedlongserviceleaveNumber2:PartnerData.Partner_LongServiceLeaves_Number,
       clientUnusedlongserviceleaveType2:PartnerData.Partner_LongServiceLeaves_Type,
  ...
  <label className="btn btn-outline-success"htmlFor="Other2">Other</label>
                ...
                <div className="col-md-12">
                  <div className="shadow px-4 py-4">
                    ...
                    {/* 1 row */}
{values.centerlink2radio=="Yes" && <div>
                        {/* 2 row */}
                      <div className="row">
                      <div className="col-md-6">
                              <div className="mb-3">
        ...
        < ErrorMessage name="InsuranceIncomeProtection" component="div"
            ...
            < ErrorMessage name="InsuranceHomeContents" component="div"
                      ...
                      {/* 2 row */}
                       ...
                       {/* 2 2nd part  row */}
                       {values.lumpsumExpensesradio=="Yes" && <div> 
                       <div className="row">
                       ...
                       {/* 2 2nd part  row */}
                        ...
                        {/*3 2nd part  row*/}
                        {values.expectingInheritancesradio=="Yes" && <div> 
                        <div className="row">
