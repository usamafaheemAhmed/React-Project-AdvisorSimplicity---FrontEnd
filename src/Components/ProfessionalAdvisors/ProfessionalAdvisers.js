                                      ...
                                      <tr key={index}>
                                        ...
                                        <td>
                                         <button  type='button' onClick={(e)=>ClientSolicitorDeleteHandler(elem)} className='btn btn-danger btn-sm'>delete</button>
                                          <button  type='button' onClick={()=>handleShow()} className='btn btn-warning btn-sm mx-2  my-1'>
                                          update</button> 
                                        </td>
                                      </tr>
                                    );
                                    ...
                                    return (
                                      <tr key={index}>
                                        ...
                                        <td>
                                           ...
                                           <button  type='button' onClick={()=>handleShow2()} className='btn btn-warning btn-sm mx-2'>update</button> 
                                        </td>
                                      </tr>
                                    );
                                  }
