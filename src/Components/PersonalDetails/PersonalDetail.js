...
const PersonalDetail = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://127.0.0.1:7000/Child`).then((res) => {
  ...
  let partnerHandler = (value) => {
    ...
    switch (selectedValue) {
      case "Married":
        ...
        document
          .getElementById("PartnerPersonalInformation")
  ...
  const validationSchema = Yup.object({
    ...
    givenNameID2: Yup.string()
      .matches(letters, "only letters")
      .required("Required"),
    employmentStatusID2: Yup.string().required("Required"),
    surnameID2: Yup.string()
      .matches(letters, "only letters")
      .required("Required"),
    HealthID2: Yup.string().required("Required"),
    preferedNameID2: Yup.string()
      .matches(letters, "only letters")
      .required("Required"),
    plannedRetirementAgeID2: Yup.number()
      .required("Required")
      .test(
        "Is positive?",
        "Age must be a positive number",
    ...
    workPhoneID2: Yup.string()
      .matches(phonePattern, "invalid phone number")
      .required("Required"),

    mobileID2: Yup.string()
      .matches(phonePattern, "invalid phone number")
      .required("Required"),
  ...
  const onSubmit2 = (values, action) => {
    ...
    let ChildDetails = {
      ...
      ChildSecondaryEducationCost:
        parseFloat(values.CostofSecondaryEducation) || 0,
    ...
    if (SubmitFlag) {
      ...
      axios
        .patch(
          `http://localhost:7000/Child/Update-Child/${email}/${id}`,
          ChildDetails
        )
        .then((res) => {
          //Popper Massage
      ...
      setTimeout(() => {
        axios.get(`http://localhost:7000/Child`).then((res) => {
          console.log("got it");
  ...
  const validationSchema2 = Yup.object({
    ...
    CostofSecondaryEducation: Yup.number().when("significantEducationRadio", {
      is: (val) => val && val.length == 3,
      then: Yup.number()
        .required("Required")
        .test(
    ...
    CostofUniEducation: Yup.number().when("significantEducationRadio", {
      is: (val) => val && val.length == 3,
      then: Yup.number()
        .required("Required")
        .test(
    ...
    courseYears: Yup.string().when("significantEducationRadio", {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required"),
      otherwise: Yup.string().notRequired(),
    }),

    DependantUntilAge: Yup.number().when("childDependentradio", {
      is: (val) => val && val.length == 3,
      then: Yup.number()
        .required("Required")
        .test(
    ...
    childSupportReceived: Yup.string().when("childDependentradio", {
      is: (val) => val && val.length == 3,
      then: Yup.string().required("Required"),
      otherwise: Yup.string().notRequired(),
    }),
  ...
  let significantCostsHandler = (e) => {
    let decRow = document.getElementById(
      "significantCostsofEducationRow"
    ).classList;
    if (e === "no") {
      decRow.add("d-none");
    } else {
                          ...
                          <div className="col-md-6">
                            <div className="mb-3">
                              ...
                              <Field
                                ...
                                placeholder="Surname"
                                onChange={(e) =>
                                  setFieldValue("surnameID", e.target.value)
                                }
                          ...
                          <div className="col-md-6">
                            <div className="mb-3">
                              ...
                              <Field
                                ...
                                className="form-select shadow  inputDesign"
                                onChange={(e) =>
                                  setFieldValue("HealthID", e.target.value)
                                }
                            ...
                            <div className="mb-3">
                              ...
                              <div className="">
                                ...
                                <div
                                  ...
                                  onClick={() => smokerHandler("notSmoker")}
                                >
                                  <img
                                    className=" img-fluid imgPerson"
                          ...
                          <div className="col-md-6">
                            <div className="mb-3">
                              ...
                              <Field
                                ...
                                name="titleID2"
                                onChange={(e) =>
                                  setFieldValue("titleID2", e.target.value)
                                }
                            ...
                            <div className="mb-3">
                              ...
                              <div className="">
                                ...
                                <div
                                  id="notSmokingID2"
                                  className="mx-1 notSelectedimage  "
                                  onClick={() => smokerHandler2("notSmoker")}
                                >
                                  <img
                                    className=" img-fluid imgPerson"
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <Field
                            ...
                            onChange={(e) =>
                              setFieldValue("homePhoneID", e.target.value)
                            }
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <Field
                            ...
                            onChange={(e) =>
                              setFieldValue("PostcodeID", e.target.value)
                            }
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <Field
                            ...
                            placeholder="Mobile"
                            onChange={(e) =>
                              setFieldValue("mobileID", e.target.value)
                            }
                        ...
                        <div className="mb-3">
                          ...
                          <div>
                            <span
                              value="0"
                              id="noChildren"
                              className=" selectedchildBtn childBtn  mx-4"
                              onClick={() => childrenHandlerzero("noChildren")}
                            >
                              0
                            </span>
                            <span
                              id="oneChildren"
                              className="childBtn text-center  mx-4"
                              onClick={() => childrenHandler("oneChildren", 1)}
                            >
                              1
                            </span>
                            <span
                              id="twoChildren"
                              className="childBtn  mx-4"
                              onClick={() => childrenHandler("twoChildren", 2)}
                            >
                              2
                            </span>
                            <span
                              ...
                              className="childBtn   mx-4"
                              onClick={() =>
                                childrenHandler("threeChildren", 3)
                              }
                            >
                              3
                            </span>
                            <span
                              id="fourChildren"
                              className="childBtn  mx-4"
                              onClick={() => childrenHandler("fourChildren", 4)}
                            >
                              4
                            </span>
                            <span
                              id="fiveChildren"
                              className="childBtn  mx-4"
                              onClick={() => childrenHandler("fiveChildren", 5)}
                            >
                              5
                            </span>
                          </div>
                        ...
                        <div className="mb-3">
                          <div>
                            ...
                            >
                              ...
                              <Formik
                                initialValues={
                                  SubmitFlag ? UpdateChild[0] : initialValues2
                                }
                                  ...
                                  <Form>
                                    <Modal.Body>
                                            ...
                                            <div className="form-check form-switch m-0 p-0 ">
                                              <div className="radiobutton">
                                                <Field
                                                  ...
                                                  checked={
                                                    values.childDependentradio ==
                                                    "Yes"
                                                  }
                                                  onClick={() =>
                                                    DependantHandler("yes")
                                                  }
                                                />
                                                <label
                                      ...
                                      >
                                        ...
                                        {values.childSupportReceived ===
                                          "Paid" && (
                                          <div
                                            className="col-md-6"
                                            id="AmountPaidReceivedRowID"
                                          >
                                            <div className="mb-3">
                                              <label
                                                htmlFor="AmountPaidReceivedID"
                                                className="form-label"
                                              >
                                                Amount Paid/Received
                                              </label>
                                              <Field
                                                ...
                                                value={
                                                  values.AmountPaidReceivedID
                                                }
                                              />
                                              <ErrorMessage
                                                className="text-danger fw-bold"
                                                component="div"
                                                name="AmountPaidReceivedID"
                                              />
                                            </div>
                                          </div>
                                        )}
                                        ...
                                        <div className="col-md-12">
                                          <div className="mb-3">
                                            <label
                                              ...
                                              className="form-label"
                                            >
                                              Will child have significant Costs
                                              of Education?
                                            </label>
                                            {/* switch button style */}
                                            <div className="form-check form-switch m-0 p-0 ">
                                              <div className="radiobutton">
                                                <Field
                                                  type="radio"
                                                  name="significantEducationRadio"
                                                  id="significantEducationOpt1"
                                                  onClick={() =>
                                                    significantCostsHandler(
                                                      "yes"
                                                    )
                                                  }
                                                  value="Yes"
                                                  checked={
                                                    values.significantEducationRadio ===
                                                    "Yes"
                                                  }
                                                />
                                                <label
                                                  htmlFor="significantEducationOpt1"
                                                  className="label1"
                                                >
                                                  <span>YES</span>
                                                </label>
                                                ...
                                                />
                                                <label
                                                  htmlFor="significantEducationOpt2"
                                                  className="label2"
                                                >
                                                  <span>NO</span>
                                                </label>
                                      ...
                                      <div
                                        className="d-none"
                                        id="significantCostsofEducationRow"
                                      >
                                        {/* row 6 */}
                                        <div className="row">
                                          ...
                                          <div className="col-md-6">
                                            <div className="mb-3">
                                              <label
                                                htmlFor="CostofPrimaryEducation"
                                                className="form-label"
                                              >
                                                Cost of Primary Education
                                              </label>
                                              <Field
                                                ...
                                                value={
                                                  values.CostofPrimaryEducation
                                                }
                                              />
                                              <ErrorMessage
                                                className="text-danger fw-bold"
                                                component="div"
                                                name="CostofPrimaryEducation"
                                              />
                                            </div>
                                          </div>
                                          {/* Cost of Primary education */}
                                          ...
                                          <div className="col-md-6">
                                            <div className="mb-3">
                                              <label
                                                htmlFor="CostofSecondaryEducation"
                                                className="form-label"
                                              >
                                                Cost of Secondary Education
                                              </label>
                                              <Field
                                                ...
                                                value={
                                                  values.CostofSecondaryEducation
                                                }
                                              />
                                              <ErrorMessage
                                                className="text-danger fw-bold"
                                                component="div"
                                                name="CostofSecondaryEducation"
                                              />
                                            </div>
                                          </div>
                                          ...
                                          <div className="col-md-6">
                                            <div className="mb-3">
                                              ...
                                              <Field
                                                ...
                                                value={
                                                  values.CostofUniEducation
                                                }
                                              />
                                              <ErrorMessage
                                                className="text-danger fw-bold"
                                                component="div"
                                                name="CostofUniEducation"
                                              />
                                            </div>
                                          </div>
                                          {/* Cost of Uni Education */}
                        ...
                        <div className="mb-3">
                          ...
                          <div className="form-check form-switch m-0 p-0 ">
                            <div className="radiobutton">
                              <input
                                type="radio"
                                name="expandFamilyradio"
                                className="form-check-input"
                                id="expandFamilyopt1"
                                value="Yes"
                                onChange={handleChange}
                                checked={values.expandFamilyradio === "Yes"}
                              />
                              <label
                                htmlFor="expandFamilyopt1"
                                className="label1"
                              >
                                <span>YES</span>
                              </label>
