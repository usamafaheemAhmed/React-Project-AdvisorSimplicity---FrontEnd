...
const EstatePlanning = () => {
  ...
  let onSubmit = (values) => {
    ...
    if (isPartnered === true) {
      ...
      axios
        .post(
          "http://localhost:7000/Client-EstatePlanning/Add-Client-EstatePlanning",
          clientData
        )
        .then((res) => {
          Navigate("/Super-And-Retirment");
      ...
      axios
        .post(
          "http://localhost:7000/Partner-EstatePlanning/Add-Partner-EstatePlanning",
          PartnerData
        )
        .then((res) =>
          console.log("Partner Estate Planning Added Successfullly!")
        );
    } else {
      console.log(clientData);
      axios
