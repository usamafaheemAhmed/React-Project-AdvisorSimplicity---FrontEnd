                              ...
                              {({values , setFieldValue ,setValues,handleChange,formik})=>
                                ...
                                <Modal.Body>
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <ErrorMessage component='div' className='text-danger fw-bold' name='ManagedFundsShareIncomePA' />
                                        </div>
                                        <div className='col-md-4'>
                                        <Field
                                                as='select'
                                        ...
                                        <Field type="number" className="form-control shadow inputDesign" 
                                        id="ManagedFundsIncomePA" name='ManagedFundsTotalIncomePA' placeholder='Total Income P.A.'/>
