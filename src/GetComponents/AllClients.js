                            ...
                            Clients.map((Element) => {
                                return(
                                    <tr>
                                        ...
                                        <td>{Element.Email}</td>
                                        <td>
                                            <button onClick={()=>UpdateClient(Element)} className='my-1 mx-1' id="UpdateButton">Edit</button>
                                            <button onClick={()=>DeleteClient(Element)} className='my-1 mx-1' id='DeleteButton'>Delete</button>
                                        </td>
                                    </tr>
                                )
                            })
